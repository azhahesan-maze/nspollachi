...
class CustomerController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.master.customer.add',compact('address_type','state','bank','account_type'));
    }
    ...
    public function edit(Customer $customer,$id)
    {
        ...
        $customer_bank_details=BankDetails::where('bank_ref_id',$id)->where('ref_table','Cus')->get();
        $customer_address_details=AddressDetails::where('address_ref_id',$id)->where('address_table','Cus')->get();
        return view('admin.master.customer.edit',compact('customer','customer_bank_details','customer_address_details','address_type','state','bank','account_type'));
    }
