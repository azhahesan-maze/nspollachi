...
class CreditNoteController extends Controller
{
    ...
    public function create()
    {
       $date = date('Y-m-d');
        ...
        return view('admin.credit_note.add',compact('date','categories','voucher_no','supplier','item','agent','brand','expense_type','estimation','rejection_in','tax','sale_entry','customer','account_head'));
    }
    ...
    public function edit($id)
    {
       ...
       $address="";
        ...
        return view('admin.credit_note.edit',compact('date','rejection_in','customer','categories','supplier','agent','brand','expense_type','item','estimation','credit_note','sale_entry','credit_note_items','credit_note_expense','address','net_value','item_gst_rs','item_amount','item_net_value','item_amount_sum','item_net_value_sum','item_gst_rs_sum','item_discount_sum','item_sgst','item_cgst','tax','expense_row_count','item_row_count','account_head'));
    }
