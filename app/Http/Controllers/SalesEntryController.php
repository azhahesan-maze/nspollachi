...
class SalesEntryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.sales_entry.add',compact('date','categories','voucher_no','supplier','item','agent','brand','expense_type','estimation','saleorder','customer'));
    }
