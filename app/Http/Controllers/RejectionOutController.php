...
class RejectionOutController extends Controller
{
    ...
    public function index()
    {
        ...
        // echo "<pre>"; print_r($p_no);
        // exit();
        return view('admin.rejection_out.view',compact('rejection_out','p_no'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.rejection_out.add',compact('date','categories','voucher_no','supplier','item','agent','brand','expense_type','estimation','purchase_entry'));
    }
    ...
    {
        $rejection_out_data = RejectionOut::where('p_no',$id);
        $rejection_out_item_data = RejectionOutItem::where('p_no',$id);
        $rejection_out_expense_data = RejectionOutExpense::where('p_no',$id);
