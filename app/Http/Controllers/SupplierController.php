...
class SupplierController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.master.supplier.add',compact('address_type','state','bank','account_type'));
    }
    ...
    public function edit(Supplier $supplier,$id)
    {
        ...
        $supplier_bank_details=BankDetails::where('bank_ref_id',$id)->where('ref_table','Supplier')->get();
        $supplier_address_details=AddressDetails::where('address_ref_id',$id)->where('address_table','Supplier')->get();
        return view('admin.master.supplier.edit',compact('supplier','supplier_bank_details','supplier_address_details','address_type','state','bank','account_type'));
