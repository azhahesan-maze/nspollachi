        ...
        <div class="form-row">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control  code" placeholder="Gst Code" name="code" value="{{old('code')}}" required>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control value" placeholder="Gst Value" name="value" value="{{old('value')}}" required>
