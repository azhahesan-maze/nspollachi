        ...
        <div class="form-row">
          ...
          <div class="col-md-8">
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control name only_allow_alp_num_dot_com_amp" placeholder="Employee Name" name="name" value="{{old('name')}}" required>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control code only_allow_alp_num_dot_com_amp" placeholder="Employee Code" name="code" value="{{old('code')}}" required>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control phone_no " placeholder="Phone No" name="phone_no" value="{{old('phone_no')}}" required>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control email" placeholder="Email" name="email" value="{{old('email')}}" required>
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control dob" placeholder="dd-mm-yyyy" name="dob" value="{{old('dob')}}" required>
