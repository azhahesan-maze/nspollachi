      ...
      <div class="form-row">
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control name only_allow_alp_num_dot_com_amp" placeholder="Designation Name" name="name" value="{{old('name',$designation->name)}}" required>
          ...
          <div class="col-md-7">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control short_name" placeholder="Short Name" name="short_name" value="{{old('short_name',$designation->short_name)}}" required >
