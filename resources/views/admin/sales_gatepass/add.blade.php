      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="{{ route('sales_gatepass_entry.index') }}">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
...
<form  method="post" class="form-horizontal" action="{{ route('sales_gatepass_entry.store') }}" id="dataInput" enctype="multipart/form-data">
      {{csrf_field()}}
                       ...
                       <div class="row col-md-12">
                                ...
                                data-placeholder="Choose Sales Order No" required="" id="so_no" onchange="supplier_details()" name="so_no" >
                                <option value=""></option>
