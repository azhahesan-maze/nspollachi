...
$(document).on("click",".edit_items",function(){
  ...
  var actual_qty = $('#actual_purchase_qty'+id).val();
  var uom = $('.uom'+id).val(); 
...
$(document).on("click",".update_items",function(){
 ...
 else
 {
  ...
  $('#actual_purchase_qty'+td_id).val($('.actual_qty').val());
