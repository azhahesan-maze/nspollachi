                  ...
                  <div class="form-group row">
                    ...
                    @endif
                      ...
                      <div class="col-md-4" style="float: right;">
                        ...
                        <font color="black" style="font-size: 150%; margin-left: 100px; font-weight: 900;">NET Value :</font>&nbsp;<font class="total_net_value" style="font-size: 150%; font-weight: 900;">{{$sale_estimation->total_net_value}}</font> 
                       </div>
...
var row_id=$('#last').val();
      ...
      $.ajax({  
        ...
        type: "GET",
        url: "{{ url('sales_estimation/getdata_item/{id}') }}",
        data: { id: item_code },             
