          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8 up_percent_div">
                <input type="text" class="form-control up_percent only_allow_digit_and_dot " placeholder="Mark Up %" name="up_percent" value="">
              ...
              <div class="col-sm-8 down_percent_div" style="display: none;">
                <input type="text" class="form-control down_percent only_allow_digit_and_dot" placeholder="Mark Down %" name="down_percent" value="">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-sm-8 up_rs_div">
                <input type="text" class="form-control up_rs only_allow_digit_and_dot" placeholder="Mark Up Rs" name="up_rs" value="">
              ...
              <div class="col-sm-8 down_rs_div" style="display: none;">
                <input type="text" class="form-control down_rs only_allow_digit_and_dot" placeholder="Mark Down Rs" name="down_rs" value="">
