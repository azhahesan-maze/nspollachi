      ...
      <div class="row">
        ...
        <div class="col-8 mr-auto">
          <ul class="h-right-btn mb-0 pl-0">
            <li><button type="button" class="btn btn-success"><a href="{{ route('credit_note.index') }}">Back</a></button></li>
          </ul>
        </div>
      </div>
    </div>
      ...
      {{csrf_field()}}
                       ...
                       <div class="row col-md-12">
                        ...
                        <div class="col-md-3">
                                ...
                                data-placeholder="Choose Sale Entry No" onchange="so_details()" id="s_no" name="s_no" >
