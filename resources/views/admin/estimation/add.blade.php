...
function calculate_total_discount()
{
  ...
  q = parseInt(q)+parseInt($(this).val());
  });
  return q;
...
$(document).on("click",".update_items",function(){
  ...
  if($('.discount_rs').val() == '' && $('.discount_percentage').val() != '')
   ...
   else if($('.discount_percentage').val() == '' && $('.discount_rs').val() != '')
   {
